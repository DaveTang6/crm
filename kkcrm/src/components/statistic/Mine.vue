<template>
	<MainTitle data-sub-title="我的" >统计</MainTitle>
...
<script>
import {customerMine, orderMine} from "@/api/statistic"
...
export default {
  ...
  methods: {
    ...
    getCustomerStatistic () {
      ...
      customerMine({'customerTime': this.customerTime})
          .then(res => {
    ...
    getOrderStatistic () {
      ...
      orderMine({'orderTime': this.orderTime})
          .then(res => {
